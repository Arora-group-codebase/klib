...
from klib.si.kmodel import KModel

__all__ = ['preresnet50', 'preresnet101', 'preresnet152']
...
class PreResNet(nn.Module):
    ...
    def __init__(self, layers, num_classes=1000, block_name='BasicBlock', norm_layer=None):
        super().__init__()
...
def _preresnet(layers, args):
    ...
    return KModel, PreResNet(layers=layers, block_name='bottleneck', norm_layer=norm_layer)


def preresnet50(args):
    return _preresnet([3, 4, 6, 3], args)


def preresnet101(args):
    return _preresnet([3, 4, 23, 3], args)


def preresnet152(args):
